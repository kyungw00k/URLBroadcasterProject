...
@Api(
        ...
        , version = "v1"
        , namespace = @ApiNamespace( ownerDomain = "UrlReceiverWidget.kyungw00k", ownerName = "UrlReceiverWidget.kyungw00k", packagePath = "" )
...
public class MessageEndpoint {
     ...
     */
    private static final String API_KEY = "AIzaSyA8zZ-iNQGs7Y93OSCPXIocprUYjYndXj0";
    ...
    public void sendMessage(@Named( "message" ) String message, User user)
        ...
        // ping registered devices
        CollectionResponse<DeviceInfo> response = endpoint.listDeviceInfo(null, null, user.getEmail());
